###############################################
# Title: NCAA WBB Efficiency Landscape Plot (Shaded + Simple Labels)
# Purpose: Visualizes 2025-26 NCAA WBB Team Efficiency
#          Quadrant shading + explanatory subtitle + simplified axis labels
# Data Source: CSV generated from 02_ncaa_wbb_efficiency_stat_grabber.R
...
#   Default (nothing to set up): your Desktop -- the same place the stat
#   grabber wrote its CSV, so the two scripts line up with no configuration.
...
team_efficiency <- read_csv(file.path(data_dir, "ncaa_wbb_efficiency_2026.csv"))

print("Loaded NCAA WBB efficiency data:")
...
out_png <- file.path(output_dir, "ncaa_wbb_efficiency_2026_beat_shaded_simplelabels.png")
