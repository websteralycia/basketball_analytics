...
school          <- "University of Michigan"   # the player's school
conference_name <- "Big Ten"                  # comparison pool (partial match OK)
season          <- 2026                       # wehoop uses END year (2026 = 2025-26)

# Another worked example, if you want to see a smaller conference:
#   main_player <- "Jamisyn Heaton"; school <- "Utah State"
