...
A win probability calculator for NCAA women's basketball. Describe a moment in
a game (quarter, time left, score difference, who has the ball) and it returns
the chance your team wins.
...
the same four controls, plus one thing theirs can't do, **name the two teams**.
